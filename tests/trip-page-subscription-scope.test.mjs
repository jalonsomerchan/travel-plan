...
describe('trip page subscription scope usage', () => {
  it('uses the shared scope for the trip page listeners', () => {
    ...
    assert.match(tripPage, /subscribeTrip/);
    assert.match(tripPage, /subscribeTripPlans/);
    assert.match(tripPage, /subscribeTripChecklistItems/);
  });
});
