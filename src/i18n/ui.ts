...
import globalSearchEn from './feature-translations/global-search/en.json';
import globalSearchEs from './feature-translations/global-search/es.json';
